...
public:
   ...
   virtual void setRenderObj(CRendererObj* robj);
   ...
   CRendererObj* getRenderObj()        { return m_sprite; }
protected:
   uint8_t  m_x = 0,  m_y = 0;      //< Coordinates
   bool  m_wantToMove = false;      //< Flag to know whether the entity wants to move
